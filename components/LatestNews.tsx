...
function LatestNews({ newsItems, className }: newsProps) {
	return (
		<div className={cn('px-3 sm:px-5 lg:px-0 lg:py-5 xl:py-0 flex flex-col', className)}>
			<div>
			...
			<div className='flex w-full flex-col pt-3 sm:pt-5 px-3 sm:px-5 lg:px-0 grow gap-2'>
